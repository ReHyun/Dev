...
//   if (id.length < 1) {
//     document.getElementById('show').innerHTML = '아이디를 입력하세요';
//   } else if (id.length > 10) {
//     document.getElementById('show').innerHTML = '아이디가 너무 깁니다.';
//   } else {
//     document.getElementById('show').innerHTML = '입력 OK❤';
//   }

//   if (pw.length < 1) {
//     document.getElementById('show').innerHTML = '비밀번호를 입력하세요';
//   } else if (pw.length > 10) {
//     document.getElementById('show').innerHTML = '비밀번호가 너무 깁니다.';
//   } else {
//     document.getElementById('show').innerHTML = '입력 OK❤';
//   }
//   ['id', 'password'].forEach((field) => (documentById(field).value = ''));
//   setTimeout(() => {
